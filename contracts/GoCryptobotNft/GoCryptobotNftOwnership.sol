...
import "./GoCryptobotNftAccessControl.sol";

contract GoCryptobotNftOwnership is GoCryptobotNftAccessControl {
    ...
    function addToken(address _to, uint256 _tokenId) private {
        ...
        assert(uint256(totalTokens + 1) >= totalTokens);
